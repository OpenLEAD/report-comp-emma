...
O raio da base $r_{b}$ (representado na figura \ref{fig::base_aro_frente}) é
limitado pelo ambiente da turbina e para cada escolha de posicionamento existem restrições específicas. 
...
\centering
	...
	\caption{Exemplo de posicionamento de um manipulador robótico em frente à
	pá. Nessa figura, a base que ficaria sob o robô não está representada.}
