...
necessá\-rios para fornecer à base do robô todos os posicionamentos
necessá\-rios, de acordo com os estudos cinemáticos e dinâmicos descritos  nas
...
$\bullet$~\textbf{Base Prismática-Rotacional-Prismática (P-R-P):}
  ...
  prismáti\-ca $1$), uma plataforma de base pivotada por mancal e rolamentos
  entre o trilho primário e secundário (junta rotacional) e um trilho secundário
...
\begin{figure}[h!]
   \centering
   \includegraphics[width=0.8\columnwidth]{detail/figs/bases/base_prp}
